...
(function () {
    ...
    var canvas = document.getElementById("canvas"),
        ...
        radialGradientPlanet = renderingContext.createRadialGradient(160, 220, 1, 180, 180, 320),
        radialGradientRing = renderingContext.createRadialGradient(115, 220, 1, 180, 120, 320),

        ring = { left: {
                     bottom: [[100, 240], [10, 280], [251, 288]],
                     center: [251, 268],
                     top: [[0, 260], [104, 220]],
                     edge: [[74, 260], [76, 240]]
                 },
    ...
    radialGradientPlanet.addColorStop(0, "#FFE6F0");
    radialGradientPlanet.addColorStop(0.5, "#FF0066");
    radialGradientPlanet.addColorStop(0.7, "#CC0099");
    radialGradientPlanet.addColorStop(0.8, "#660066");
    radialGradientPlanet.addColorStop(1, "#660029");
